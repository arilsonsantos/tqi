...
public class AddressControllerTest {
    ...
    public void findAValidCEP() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get(ADDRESS_API + "/" + cep).accept(MediaType.APPLICATION_JSON)
    ...
    public void findAInvalidFormatedCEP() throws Exception {
        ...
        BDDMockito.given(service.getByCep(cep))
                .willThrow(new CepInvalidFormatException("O CEP deve ter um dos seguintes formatos: 99999-999 ou 99999999"));

        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get(ADDRESS_API.concat("/" + cep));

        mvc.perform(request).andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.content().string("O CEP deve ter um dos seguintes formatos: 99999-999 ou 99999999"));
    }
